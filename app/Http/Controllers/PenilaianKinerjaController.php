...
class PenilaianKinerjaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'koordinasi' => 'required',
            'motivasi_kerja' => 'required'
        ]);

        $final_value = ($request->responsible + $request->initiate + $request->teamwork + $request->work_performance + $request->discipline + $request->ketepatan_waktu + $request->koordinasi + $request->motivasi_kerja) / 8;
        PenilaianPegawai::create([
            ...
            'motivasi_kerja' => $request->motivasi_kerja,
    ...
    public function update(Request $request, $data)
    {
        ...
        $penilaian->ketepatan_waktu = $request->ketepatan_waktu;
        $penilaian->koordinasi = $request->koordinasi;
        $penilaian->motivasi_kerja = $request->motivasi_kerja;
    ...
    public function destroy($data)
    {
        //
        $id = Crypt::decryptString($data);
        $penilaian_pegawai = PenilaianPegawai::find($id);
        $penilaian_pegawai->delete();

        Alert::success('success', ' Berhasil Hapus Data !');
        return redirect(route('penilaian.show', Crypt::encryptString($penilaian_pegawai->id_pegawai)));
    }
