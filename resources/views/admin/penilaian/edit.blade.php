                    ...
                    <div class="col-md-7">
                        <div class="panel ">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row mt-3">
                                    <div class="form-group">
                                        <label class="control-label col-lg-2">Ketepatan Waktu</label>
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="ketepatan_waktu"
                                                value="{{ $penilaian->ketepatan_waktu }}" placeholder="Skala 10-100">
                                        </div>

                                        @if ($errors->has('ketepatan_waktu'))
                                            <div class="text-danger">
                                                {{ $errors->first('ketepatan_waktu') }}
                                            </div>
                                        @endif
                                        </d>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="form-group">
                                        <label class="control-label col-lg-2">Koordinasi</label>
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="koordinasi"
                                                value="{{ $penilaian->koordinasi }}" placeholder="Skala 10-100">
                                        </div>

                                        @if ($errors->has('koordinasi'))
                                            <div class="text-danger">
                                                {{ $errors->first('koordinasi') }}
                                            </div>
                                        @endif
                                        </d>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="form-group">
                                        <label class="control-label col-lg-2">Motivasi Kerja</label>
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="motivasi_kerja"
                                                value="{{ $penilaian->motivasi_kerja }}" placeholder="Skala 10-100">
                                        </div>

                                        @if ($errors->has('motivasi_kerja'))
                                            <div class="text-danger">
                                                {{ $errors->first('motivasi_kerja') }}
                                            </div>
                                        @endif
                                        </d>
                                    </div>
