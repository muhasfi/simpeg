                    ...
                    @if ($penilaian->count())
                        @foreach ($penilaian as $key => $p)
                            <tr>
                                ...
                                <td>
                                    {{ ($p->responsible + $p->initiate + $p->teamwork + $p->discipline 
                                    + $p->work_performance + $p->ketepatan_waktu + $p->koordinasi + $p->motivasi_kerja) / 8 }}
                                </td>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="{{ route('penilaian.destroy', $enc_id) }}"><i
