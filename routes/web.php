...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/penilaian/destroy/{data}', [PenilaianKinerjaController::class, 'destroy'])->name('penilaian.destroy');
    Route::get('penilaian/export', [PenilaianKinerjaController::class, 'export'])->name('penilaian.export');
});
